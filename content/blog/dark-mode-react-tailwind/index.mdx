...
🚀 You can find the source in [GitHub](https://github.com/mick-schroeder/dark-mode-react-tailwind) and the demo [here](https://awesome-heyrovsky-f51f39.netlify.app/).
